...
class TempDB {
  ...
  static List<BusRoute> tableRoute = [
    BusRoute(routeId: 1, routeName: 'Kathmandu-Butwal', cityFrom: 'Kathmandu', cityTo: 'Butwal', distanceInKm: 250),
    BusRoute(routeId: 2, routeName: 'Butwal-Kathmandu', cityFrom: 'Butwal', cityTo: 'Kathmandu', distanceInKm: 250),
  ];
